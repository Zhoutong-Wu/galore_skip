...
from transformers.models.llama.modeling_llama_skip import LlamaForCausalLM as HF_LlamaForCausalLM
...
def evaluate_model(model, preprocess_batched, pad_idx, global_rank, world_size, device, batch_size):
    ...
    val_data = datasets.load_dataset("/data0/jjwang/datasets/c4/en", split='validation', streaming=True, cache_dir="/home/ztwu/cache")
...
def main(args):
    ...
    data = datasets.load_dataset("/data0/jjwang/datasets/c4/en", split='train', streaming=True)
    ...
    if args.continue_from is not None:
        ...
        if os.path.exists(optimizer_ckpt_path):
            optimizer_checkpoint = torch.load(optimizer_ckpt_path, map_location="cpu")
