...
from peft_pretraining.modeling_llama_resformer import LlamaForCausalLM
...
def main(args):
    ...
    tokenizer = AutoTokenizer.from_pretrained("/GLOBALFS/gbu_cinco_2/zy/WZT/t5-base", model_max_length=args.max_length)
