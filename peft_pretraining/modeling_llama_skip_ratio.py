...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig, layer_num, merge_heads=None,):
        ...
        self.skip_head_ratio = config.skip_head_ratio
        ...
        # 控制合并的头数，表示不动的头数，默认为 self.num_heads // 2
        # self.merge_heads = merge_heads if merge_heads is not None else self.num_heads // 2
        self.skip_heads = round(self.num_heads * self.skip_head_ratio)
        self.merge_heads = self.num_heads - self.skip_heads
